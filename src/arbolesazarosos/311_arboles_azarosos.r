...
set.seed(442903) #Establezco la semilla aleatoria, cambiar por SU primer semilla
...
dir.create( "./labo/exp/KA2102/", showWarnings = FALSE )

#aqui es donde voy a graficar los arboles
pdf( "./labo/exp/KA2101/arbolitos1.pdf", paper="a4r" )
...
fwrite( tb_ensembles,
        file="./labo/exp/KA2101/ensemble1.csv",
        sep="\t" )
...
fwrite( entrega, 
        file= "./labo/exp/KA2101/K311_002.csv", 
        sep= "," )

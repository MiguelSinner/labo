...
kBO_iter  <- 80   #cantidad de iteraciones de la Optimizacion Bayesiana
...
ksemilla_azar  <- 442837  #Aqui poner la propia semilla
...
setwd("C:/Users/Migue/Desktop/Facultad Migue/Laboratorio1/labo/exp/HT4330")   #Establezco el Working Directory DEL EXPERIMENTO

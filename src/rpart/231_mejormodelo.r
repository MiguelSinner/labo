...
ksemillas  <- c( 442837, 442843, 442861, 442879, 442903 ) #reemplazar por las propias semillas
...
setwd("C:\\Users\\Migue\\Desktop\\Laboratorio1")   #Establezco el Working Directory
#cargo los datos

dataset  <- fread("./datasets/paquete_premium_202011.csv")

paramA  <- list( "cp"=         -0.36,  #complejidad minima
                 "minsplit"=  1686,  #minima cantidad de registros en un nodo para hacer el split
                 "minbucket"= 720,  #minima cantidad de registros en una hoja
                 "maxdepth"=    5 ) #profundidad máxima del arbol

paramB  <- list( "cp"=          -0.34,  #complejidad minima
                 "minsplit"=   1684,  #minima cantidad de registros en un nodo para hacer el split
                 "minbucket"=   5,  #minima cantidad de registros en una hoja
                 "maxdepth"=   5 ) #profundidad máxima del arbol

paramC  <- list( "cp"=         -0.37,  #complejidad minima
                 "minsplit"=   1683,  #minima cantidad de registros en un nodo para hacer el split
                 "minbucket"=  5,  #minima cantidad de registros en una hoja
                 "maxdepth"=    5 ) #profundidad máxima del arbol

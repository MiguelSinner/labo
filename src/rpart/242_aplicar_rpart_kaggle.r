...
param_basicos  <- list( "cp"=          -0.354,  #complejidad minima
                        "minsplit"=   1685,     #minima cantidad de registros en un nodo para hacer el split
                        "minbucket"=  719,     #minima cantidad de registros en una hoja
